 ...
 * Description:格式化电话/身份证的editText
 */
public class FormatEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener {
